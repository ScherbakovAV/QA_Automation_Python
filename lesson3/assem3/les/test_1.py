...
# pytest --junitxml=report.xml // для отчёта в формате xml
# pytest --html=report.html // для отчёта в формате html (плагин pytest-html)
# pytest --html-report=report.html // для отчёта в формате html (плагин pytest-html-reporter - более новый)
# pytest.ini // для запуска всех тестов с указанными параметрами
